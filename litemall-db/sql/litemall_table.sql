...
CREATE TABLE `litemall_order_etm` (
  ...
  `size` decimal(16,2)  NOT NULL DEFAULT '0' COMMENT '数量',
  `price` decimal(16,6) NOT NULL DEFAULT '0' COMMENT '实时价格',
  `cost` decimal(16,2)  NOT NULL DEFAULT '0' COMMENT '总花费 cny',
...
/*!40101 SET character_set_client = utf8 */;
 ...
 `username` varchar(63) NOT NULL DEFAULT '' COMMENT '名称',
  ...
  `type` smallint(6) NOT NULL COMMENT '类型 1.支付宝 2.微信',
